...
correctness, cost and wall-clock. Until then the retrieval service's own harness
(golden set, judge and `run_eval.py`) stays in
[`services/rag/eval/`](../services/rag/eval/).
